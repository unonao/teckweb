	...
	<div id="fh5co-wrap">
		...
		<div class="fh5co-section">
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<p>6/9(土)と10(日)の2日間、尾瀬に合宿をしに行きます。<br/>皆さんが参加する新歓期には泊まり企画が2つあって、1つ目は新歓キャンプ、2つ目がこの新歓合宿です。<br/>この合宿の前までには大学毎に装備買い出しがあり、初めてザックを背負い、山靴をはいて、山ボーイ・山ガールとして参加する泊まり企画になります。</p>
					</div>
					<div class="col-md-7">
	...
	<div id="fh5co-wrap">
		...
		<div class="fh5co-section">
			<div class="container">
				<div class="row">
					<dl>
						<dt>Q掛け持ちはできる？</dt><dd>A活動日が週末以外のサークルならOKです。活動日が週末でも可能ですが、できるだけテクの企画にも来られるようにしてほしいです。</dd>
						<dt>Q山のレベルは？</dt><dd>A週末山行は初心者でも大丈夫です！また夏山は3000m級の山を登りますが、その頃には週末山行で十分な経験を積んでいます。ペースも1年生に合わせるのでご心配なく。</dd>
						<dt>Q本当に安全？？</dt><dd>A冬山や沢登りはしません。また、すべての企画は先輩方と安全性をじっくり審議したうえで実施しています。</dd>
						<dt>Qレクのみの参加でもいい？</dt><dd>A参加の強制はしないですが、できるだけ山にも来てほしいです。</dd>
						...
						<dt>Q本当に安全？？</dt><dd>A冬山や沢登りはしません。また、すべての企画は先輩方と安全性をじっくり審議したうえで実施しています。</dd>
						<dt>Q何人くらいのサークル？</dt><dd>A1学年30人前後です。</dd>
						<dt>Qセレクションはある？</dt><dd>A入会希望者が想定を超えた際、抽選を行うことがあります。多すぎると山での安全が確保できなくなる可能性があるためです。抽選は参加した企画ごとに決められたポイントの合計で決まるので、なるべく多くの山行企画に参加してください。</dd>
						<dt>Q2年生からも入れる？</dt><dd>A入れます。ただし45期（1年生と同じ扱い）になります。また人数が多かった場合、1年生の方が入会に有利になるようにしています。</dd>
					</dl>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						...
						<p>企画への参加希望の場合は、「大学名・学年・学部学科・氏名・参加したい企画」を明記してください。定員がある企画は先着順なので、参加できない場合があることをご了承ください。</p>

						<p>※こちらのフォームですが、4/1までエラーが有ったので正しく機能していなかった場合があります。お手数ですが、返信がなければもう一度送り直すようにお願いします。<p>
