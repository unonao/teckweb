		...
		<div class="fh5co-parallax" style="background-image: url(images/shinkan.jpg);" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell">
							<h1 class="text-center">新歓情報2017</h1>
		...
		<div class="fh5co-section">
			<div class="container">
				<ul class="clearfix">
					...
					<li class="animated wow fadeInDown" data-wow-delay="1.6s" style="visibility: visible; animation-delay: 1.6s; animation-name: fadeInDown;">
						<div class="media">
							<a href="#9">
					...
					<li class="animated wow fadeInDown" data-wow-delay="1.8s" style="visibility: visible; animation-delay: 1.8s; animation-name: fadeInDown;">
						<div class="media">
